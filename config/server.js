...
const dbName = process.env.DB_NAME || 'bazarbuy';
...
module.exports = {
	...
	// key to sign tokens
	jwtSecretKey: process.env.JWT_SECRET_KEY || 'iEp5561DLJzsegtyG8t0Ure2PmKrP5RT',

	// key to sign store cookies
	cookieSecretKey: process.env.COOKIE_SECRET_KEY || 'VNlrOkqDC8HgvOvsg98tvulyCAmAboiC',
